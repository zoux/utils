...
const zouxin = {
  ...
  /**
   * @method  isType(el, type)
   *
   * @param   {all}     el 判断的对象
   * @param   {string}  type 指定的类型
   *
   * @return  {boolean} 类型是否正确
   */
  isType(el, type) {
    switch (type.toLowerCase()) {
      ...
      case 'undefined':
        return Object.prototype.toString.call(el) === '[object Undefined]';
      case 'null':
        return Object.prototype.toString.call(el) === '[object Null]';
      case 'function':
      ...
      case 'elements':
        return Object.prototype.toString.call(el).indexOf('HTML') !== -1;
      default:
